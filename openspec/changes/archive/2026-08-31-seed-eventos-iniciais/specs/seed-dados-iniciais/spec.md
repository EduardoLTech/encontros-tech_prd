# Semeadura de dados iniciais

> **PRD de origem:** `docs/prds/PRD-0002-seed-eventos.md` (Rascunho, 2026-07-12).
> Cada requisito abaixo mapeia os predicados (P), invariantes (I) e restrições (R) daquele documento.
> Premissas fixadas nesta mudança e não presentes no PRD original: execução **serializada**
> (concorrência fora de escopo) e algoritmo de datas por **deslocamento em bloco** — ver `design.md`.
